...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-04-24',
    changes: [
      '🔥 إصلاح حرج: التكلفة الإجمالية لم تكن تحسب!',
      '💾 حفظ السعر والمتجر المختار في قاعدة البيانات',
      '📊 إضافة debugging لتتبع الأسعار',
      '✅ الآن التكلفة تُحسب بشكل صحيح',
    ]
  },
  {
    version: '1.8.4',
    date: '2026-04-24',
    changes: [
      '💰 إضافة حقل السعر عند إضافة منتج جديد',
      '🏪 اختيار المتجر مباشرة عند الإضافة',
