...
export const CHANGELOG = [
  {
    ...
    date: '2026-04-24',
    changes: [
      '🔥 إصلاح حرج: مسح جميع الكاش القديم',
      '🔄 استخدام Network First لضمان أحدث الملفات',
  ...
  },
  {
    ...
    date: '2026-04-24',
    changes: [
      '🔧 إصلاح: خطأ 500 في تصنيف المنتجات',
      '🔧 إصلاح: خطأ JavaScript "r7" في المتصفح',
      '🔄 تحديث الكاش لإجبار تحديث التطبيق',
      '⚡ تحسين: تصنيف أسرع بدون AI (محلي فقط)',
    ]
  },
  {
    version: '1.8.0',
